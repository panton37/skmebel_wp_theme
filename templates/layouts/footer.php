<footer class="container lg:px-20 lg:pt-9">
            ...
            <div class="my-10">
                <div class="flex gap-x-4">
                        ...
                        <svg class="w-6 h-6"
                            ...
                            <g clip-path="url(#clip0_651_763)">
                                <path class="group-hover:fill-primary-hover-100 ease-in-out transition-colors duration-300"
                                        d="M16 32C24.8366 32 32 24.8366 32 16C32 7.16344 24.8366 0 16 0C7.16344 0 0 7.16344 0 16C0 24.8366 7.16344 32 16 32Z" fill="black"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.24139 15.8309L16.5723 11.8117C21.0157 9.96357 21.9389 9.64254 22.5407 9.63195C22.6731 9.62961 22.969 9.66241 23.1607 9.81797C23.3226 9.94929 23.3671 10.1268 23.3885 10.2512C23.4098 10.3757 23.4363 10.6595 23.4152 10.8811C23.1744 13.4111 22.1325 19.5507 21.6025 22.3843C21.3782 23.5833 20.9369 23.9854 20.509 24.0247C19.5799 24.1102 18.8743 23.4106 17.9744 22.8207L14.4037 20.4222C12.824 19.3813 13.848 18.8091 14.7483 17.8741C14.9839 17.6293 19.0778 13.9056 19.157 13.5678C19.1666 13.5256 19.1761 13.3681 19.0825 13.2849C18.989 13.2017 18.8509 13.2305 18.7512 13.2528C18.61 13.2849 16.3604 14.7718 12.0024 17.7136C11.3638 18.1521 10.7854 18.3658 10.2672 18.3546C9.69595 18.3423 8.59704 18.0316 7.78011 17.766C6.7781 17.4403 5.98171 17.2681 6.05109 16.715C6.08718 16.4269 6.48395 16.1322 7.24136 15.831L7.24139 15.8309Z" fill="white"/>
                            </g>
                            <defs>
                                <clipPath id="clip0_651_763">
                    ...
                    <a href="<?php the_field('main_whatsapp', 'option'); ?>" class="group">
                        ...
                        <path class="group-hover:fill-primary-hover-100 ease-in-out transition-colors duration-300" d="M0,58l4.988-14.963C2.457,38.78,1,33.812,1,28.5C1,12.76,13.76,0,29.5,0S58,12.76,58,28.5
                    ...
                    <a href="<?php the_field('main_vk', 'option'); ?>" class="group">
                        ...
                        <svg class="w-6 h-6"
                            ...
                            <g clip-path="url(#clip0_651_768)">
                                <path class="group-hover:fill-primary-hover-100 ease-in-out transition-colors duration-300"
                                        d="M0 15.36C0 8.11733 0 4.50133 2.24 2.24C4.512 0 8.128 0 15.36 0H16.64C23.8827 0 27.4987 0 29.76 2.24C32 4.512 32 8.128 32 15.36V16.64C32 23.8827 32 27.4987 29.76 29.76C27.488 32 23.872 32 16.64 32H15.36C8.11733 32 4.50133 32 2.24 29.76C0 27.488 0 23.872 0 16.64V15.36Z" fill="black"/>
                                <path d="M17.0251 23.0502C9.7291 23.0502 5.5691 18.0582 5.39844 9.73821H9.06777C9.1851 15.8395 11.8731 18.4209 14.0064 18.9542V9.73821H17.4518V14.9969C19.5531 14.7729 21.7718 12.3729 22.5184 9.72754H25.9531C25.6731 11.0969 25.1136 12.3938 24.3098 13.5372C23.5059 14.6806 22.4749 15.6459 21.2811 16.3729C22.6133 17.0359 23.7898 17.9739 24.733 19.1249C25.6762 20.2758 26.3647 21.6137 26.7531 23.0502H22.9664C22.1558 20.5222 20.1291 18.5595 17.4518 18.2929V23.0502H17.0358H17.0251Z" fill="white"/>
                            </g>
                            <defs>
                                <clipPath id="clip0_651_768">
                                    <rect width="32" height="32" fill="white"/>
                                </clipPath>
                            </defs>
                        </svg>
    ...
    <div class="flex justify-between lg:hidden fixed z-40 bottom-0 left-0 right-0 border-t border-primary-black-25">
        ...
        <a class="flex items-center justify-center w-full bg-primary-black-44 py-4" href="#">
            <svg class="mr-2" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
