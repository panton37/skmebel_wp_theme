    ...
    <div class="xl:px-20 pl-5 lg:pl-0 min-w-full grid grid-cols-1">
        ...
        <div class="slider-4060 relative w-full h-full swiper">
            ...
            <div class="swiper-wrapper min-h-[190px] lg:min-h-[600px]">
                ...
                <div class="max-w-[90%] w-full swiper-slide lg:w-full lg:odd:w-[calc(40%-25px/2)] lg:even:w-[calc(60%-25px/2)] h-full">
