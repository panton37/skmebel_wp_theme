<?php $images = get_field('slider_basic_imgs'); ?>

<section class="container mb-12 lg:mb-24">
    <div class="px-5 lg:px-20 min-w-full grid grid-cols-1">
        <!-- Slider main container -->
        <div class="relative w-full h-full swiper main-swiper basic-swiper">
            <!-- Navigation buttons -->
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide lg:min-h-[516px] h-[286px] max-w-[90%]">
                    <img class="w-full max-h-[286px] h-full lg:min-w-full lg:min-h-full lg:rounded-[40px] rounded-xl object-cover"
